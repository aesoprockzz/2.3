...
{
	public abstract class BaseChuckableSpear : BaseMeleeWeapon
	{
		...
		public BaseChuckableSpear( int itemID ) : base( itemID )
		{
		}

		public BaseChuckableSpear( Serial serial ) : base( serial )
		{
		}
