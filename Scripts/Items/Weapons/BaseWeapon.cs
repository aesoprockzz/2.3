...
namespace Server.Items
{
	...
	public abstract class BaseWeapon : Item, IWeapon, IFactionItem, ICraftable, ISlayer, IDurability
	{
		...
		public virtual bool CheckHit( Mobile attacker, Mobile defender )
		{
			...
			double atkValue = 100;//atkWeapon.GetAttackSkillValue( attacker, defender );
			double defValue = 100;//defWeapon.GetDefendSkillValue( attacker, defender );
		...
		public virtual double ScaleDamageOld( Mobile attacker, double damage, bool checkSkills )
		{
			 ...
			 */
			/*double anatomyValue = 0;//attacker.Skills[SkillName.Anatomy].Value;
			...
			/*if ( Type == WeaponType.Axe )
			{
				double lumberValue = 0;//attacker.Skills[SkillName.Lumberjacking].Value;
